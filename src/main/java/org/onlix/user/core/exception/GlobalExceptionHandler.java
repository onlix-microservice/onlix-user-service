package org.onlix.user.core.exception;
...
import org.onlix.user.core.utils.LogUtils;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAccountCustomException(AccountCustomException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleJwtAuthenticationCustomException(JwtAuthenticationCustomException ex) {
        BaseErrorCode errorCode = ex.getErrorCode();
