package org.onlix.user.auth.controller;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequestDto) {
        JwtResponse jwtResponseDto = authService.login(loginRequestDto);
    ...
    public ResponseEntity<?> refresh(HttpServletRequest request) {
        JwtResponse jwtResponseDto = authService.refresh(request);
